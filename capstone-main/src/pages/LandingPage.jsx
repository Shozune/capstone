...
const officeCards = [
  ...
  {
    title: "Admissions",
    description: "Enrollment & student records",
    Icon: Building2,
  },
  {
              ...
              <div className="lp-benefits">
                {benefits.map((b) => (
                  <div key={b.title} className="lp-benefit">
                    <div className="lp-benefit-check lp-check-ring">
                      <CircleCheck
                        className={ICON_CLASS}
                        size={23}
                        strokeWidth={2}
          ...
          <div className="lp-footer-grid lp-reveal">
            ...
            <div className="lp-footer-col">
              ...
              <ul className="lp-footer-list">
                ...
                <li>
                  <a href="#platform-features">Guidance</a>
                </li>
                <li>
                  <a href="#platform-features">Discipline</a>
                </li>
                <li>
                  <Link to="/sdao">Student Development</Link>
                </li>
              </ul>
            </div>
            <div className="lp-footer-col">
