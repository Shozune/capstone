...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const role = roleByOffice[office] || "Staff";
    ...
    <div className="signup-page auth-split-page">
      <div className="auth-split-card">
        <div className="auth-split-form-panel auth-split-form-panel--scroll">
          <div className="auth-split-form-top">
            ...
            <div className="auth-split-logo-row">
              <img src={campusCareLogo} alt="" width={40} height={40} />
          ...
          <p className="auth-split-subtitle">
            All fields marked with * are required. Choose your office for correct access after sign-in.
          </p>
        ...
        <AuthSplitAside
          ...
          subtitle="Register with your office so CampusCare routes you to the right dashboard—Health Services, Dean’s Office, or SDAO—automatically when you sign in."
        />
      </div>
    </div>
  );
