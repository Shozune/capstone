...
import campusCareBlue from "../assets/CampusCareBlue.png";
...
/**
 * Password reset uses a 6-digit code: verifyOtp({ email, token, type: 'recovery' }).
      ...
      <div className="forgot-password-container">
        <div className="forgot-password-left">
          ...
          <div className="forgot-password-heading-section">
            ...
            <p>
              Enter your university email address and we&apos;ll send you a verification code to reset
